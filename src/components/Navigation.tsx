...
const Navigation = () => {
  ...
  function Scroll(id: string, position: boolean) {
  ...
  return (
    <>
      <nav className="nav">
        ...
        <ul className="nav__links navbar-nav">
          <li className="nav-item">
            <a className="nav-link" onClick={() => Scroll("#Welcome", true)}>
              {t("nav__link_welcome")}
            </a>
          </li>
          <li className="nav-item">
            <a className="nav-link" onClick={() => Scroll("#Welcome", false)}>
              {t("Sax-parts")}
            </a>
          </li>
          <li className="nav-item">
            <a className="nav-link" onClick={() => Scroll("#History", true)}>
              {t("History")}
            </a>
          </li>
          <li className="nav-item">
            <a className="nav-link" onClick={() => Scroll("#Types", true)}>
              {t("Sax-types")}
            </a>
          </li>
        </ul>
        ...
        <div className="nav__hamburger">
          <input
            type="checkbox"
            className="nav__hamburger_checkbox"
            id="hamburger-input"
            onChange={() => setNavBarState(!navbarState)}
          />
      ...
      <div
        className={navbarState ? "mobile-nav" : "mobile-nav hidden"}
        id="mobile-nav"
      >
        <ul className="mobile-nav__links">
          <li className="mobile-nav__links_nav-item">
            <a className="nav-link" onClick={() => Scroll("#Welcome", true)}>
              {t("nav__link_welcome")}
            </a>
          </li>
          <li className="mobile-nav__links_nav-item">
            <a
              className="nav-link"
              onClick={() => Scroll("#Second-slide", true)}
            >
              {t("Sax-parts")}
            </a>
          </li>
